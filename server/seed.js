...
function seed() {
  ...
  const properties = [
    ...
    { id: 'prop_arc_arms', name: 'ARC Arms Works', type: 'military', kind: 'factory', provinceId: 'prov_lachevan', pos: [750, 190], ownerId: 'ent_arc', value: 20000000, employees: 1400, income: 0, expenses: 4500, prodMode: 'goods', produces: [{ itemId: 'item_gun_arc_m58', perTurn: 40 }], cashPerTurn: 0, description: 'State arsenal of the Republic — ARC-run production line for the M38 service rifle. Its yard depot feeds the army in wartime.', inventory: [], vars: {} },
    // Mezdov
